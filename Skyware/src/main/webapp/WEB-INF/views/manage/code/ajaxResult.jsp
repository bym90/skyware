...
<table class="table table-hover">
	...
	<tr>
		...
		<td><input type="button" id="btnCodeUpt" name="btnCodeUpt" class="btn btn-primary" value="수정"></td>
		<td><input type="button" id="btnCodeDel" name="btnCodeDel" class="btn btn-primary" value="삭제"></td>
	</tr>
	</c:forEach>
</table>